						...
						<div className="Blog-details-Section-2-data">
							<Row>
								...
								<Col xl={4} lg={4} md={4} className="lg-mb-2">
									<iframe height="450" width="100%" frameBorder="0"  src={"https://staging-ascstaging.kinsta.cloud/gravity-sport-flyer/?form_page="+sport_name+"&id="+id+"&url="+this.state.currentURL} title="description" />
...
export const pageQuery = graphql`
  query($id: String!) {
    allWordpressWpCpt150999(filter: {id: { eq: $id }}) {
		edges {
			next {
				slug
				title
