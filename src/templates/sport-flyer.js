...
componentDidMount() {
	...
	var path  = '/flyer/';
	var url_v  = 'https://staging-ascstaging.kinsta.cloud/flyer/';
	var source = '';
	var userId = '';
                    ...
                    <Breadcrumb>
						...
						<Breadcrumb.Item className="">
								...
								<Breadcrumb.Item active className="">
									<Link className="nav-link p-0" to="/sport-flyer">Sport flyer</Link>
								</Breadcrumb.Item>		
                    </Breadcrumb>
						...
						<Tab.Container id="left-tabs-example" defaultActiveKey="Blog">
							<div className="p-0 border-0 justify-content-center d-flex mb-30">
								<Nav variant="pills" className="">
									...
									<Nav.Item>
										<Nav.Link href="/flyer" className="uppercase font-bold nav-link">Camp flyer</Nav.Link>
									</Nav.Item>
									<Nav.Item>
										<Nav.Link href="/sport-flyer" className="uppercase font-bold nav-link active">Sport flyer</Nav.Link>
									</Nav.Item>
								</Nav>
							</div>
							<Tab.Content className="text-left">
								<Tab.Pane eventKey="Blog">
									...
									<Container>
										<div className="Resource-guides-data">
											<Row className="">
												<p className="text-success" > No Sport flyers found at the moment  </p>
											</Row>
										</div>
									</Container>
									)}
...
export const pageQuery = graphql`
	query($skip: Int!, $limit: Int!) {
		allWordpressWpCpt150999(skip: $skip, limit: $limit) {
		edges {
			node {
				id
				acf {
